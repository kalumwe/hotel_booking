...
//store variable id if GET exists and is numeric
...
<script type='text/javascript'>
    alert('Your Manager has been Updated Successfully');
</script>"; 
    $url = "http://localhost:8080/hotel/admin/view-managers.php?updated=true&manager=$u_id";
    header("Location: $url");
    exit;
   } else {
    // echo "
...
?>     
    ...
    <div class="container ">
           <h2 class="text-center mb-3 pt-5">Edit Manager</h2>
...
if (isset($row['uname'])){
echo "<p class='text-muted'>".$user->safe($row['uname'])."'s Profile";
} 
echo '</p>';?></span>
...
<hr class="  mx-auto mb-5">
            ...
            <form action="edit-account.php" method="post" name="reg" enctype="multipart/form-data" id="contactForm"
